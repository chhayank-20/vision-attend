    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-200">
        <div className="text-sm">
          <p className="font-black text-slate-800 uppercase tracking-widest text-xs mb-1">
            Configuration Helper
          </p>
          <p className="text-slate-500">
            Faces detected outside the blue box will be ignored to save
            resources.
          </p>
        </div>
        <div className="flex space-x-3">
          <Button
            ...
            className="h-10 px-4 rounded-lg font-bold border-slate-300"
          >
            <RefreshCw className="mr-2" size={16} /> Reset
          </Button>
          <Button
            onClick={saveROI}
            className="bg-blue-600 hover:bg-blue-700 h-10 px-6 rounded-lg font-bold shadow-lg shadow-blue-100 transition-all hover:scale-105"
          >
