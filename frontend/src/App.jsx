        ...
        <header className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500">
              {selectedCamera
                ? 'Draw a box to define the recognition area.'
                : `Welcome back, ${
                    user?.name.split(' ')[0]
          ...
          <div className="flex items-center space-x-3">
            ...
            {activeTab === 'users' && (
              <UserEnrollment onComplete={refetchUsers} />
            )}
          </div>
        </header>
        ...
        <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                  <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8 min-h-[400px]">
                    <h3 className="text-lg font-black text-slate-800 uppercase tracking-widest mb-6">
                      Attendance Trends
                    </h3>
          ...
          {activeTab === 'users' && (
            <div className="space-y-8">
              ...
              <div className="pt-4">
                <h4 className="text-sm font-black text-slate-400 uppercase tracking-widest mb-4 ml-1">
                  Advanced Tools
                </h4>
          ...
          {activeTab === 'settings' && (
            <div className="space-y-8">
              ...
              <div className="pt-8">
                <h3 className="text-xl font-black text-slate-800 uppercase tracking-widest mb-6 ml-1">
                  Enrollment Requests
                </h3>
                <EnrollmentManager />
              </div>
            ...
            activeTab !== 'settings' && (
              <div className="bg-white rounded-2xl border border-slate-200 p-12 shadow-sm flex items-center justify-center text-slate-300">
                <div className="text-center">
                  ...
                  <p className="text-sm">
                    The {activeTab} view is under construction.
                  </p>
                </div>
              </div>
            )}
